...
class SigningActivity : BaseActivity(), View.OnClickListener {
            ...
            .addOnCompleteListener(this) { task ->
                if (task.isSuccessful) {
                    ...
                    user?.let {
                        ...
                        createNewUser(it.uid,it.displayName,it.email)
                    }
                    val intent = Intent(this@SigningActivity, MainActivity::class.java)
    ...
    private fun createNewUser(userId: String, name: String?, email: String?) {
